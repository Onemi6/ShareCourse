...
public class ParentSystemSetupActivity extends Activity implements OnClickListener{
	 @Override
	...
	public void onClick(View v) {
		...
		case R.id.accountManagement:
			...
			break;
		case R.id.feedback:
			AlertDialog.Builder dialog = new AlertDialog.Builder(ParentSystemSetupActivity.this);
		...
		case R.id.aboutSystem:
			dialog = new AlertDialog.Builder(ParentSystemSetupActivity.this);
